...
abi = json.loads('[{"constant":true,"inputs":[],"name":"name","outputs":[{"name":"","type":"string"}],'
                 ...
                 '"type":"uint8"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,'
                 '"inputs":[{"name":"","type":"address"}],"name":"balanceOf","outputs":[{"name":"",'
                 ...
                 '"stateMutability":"payable","type":"fallback"},{"anonymous":false,"inputs":[{"indexed":true,'
                 '"name":"src","type":"address"},{"indexed":true,"name":"guy","type":"address"},{"indexed":false,'
                 '"name":"wad","type":"uint256"}],"name":"Approval","type":"event"},{"anonymous":false,"inputs":[{'
                 '"indexed":true,"name":"src","type":"address"},{"indexed":true,"name":"dst","type":"address"},'
                 '{"indexed":false,"name":"wad","type":"uint256"}],"name":"Transfer","type":"event"},'
                 '{"anonymous":false,"inputs":[{"indexed":true,"name":"dst","type":"address"},{"indexed":false,'
                 '"name":"wad","type":"uint256"}],"name":"Deposit","type":"event"},{"anonymous":false,"inputs":[{'
                 '"indexed":true,"name":"src","type":"address"},{"indexed":false,"name":"wad","type":"uint256"}],'
                 '"name":"Withdrawal","type":"event"}]')

contract = web3.eth.contract(address=address, abi=abi)
main_address = '0x1DFaD3f4B8523676a975D9e44647B8d5ca086907'

my_balance = contract.functions.balanceOf(main_address).call()
print(web3.fromWei(my_balance, 'ether'))
